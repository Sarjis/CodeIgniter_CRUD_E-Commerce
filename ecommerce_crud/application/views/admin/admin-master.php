...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo base_url('dashboard') ?>">E-Shopper Admin View</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li class="divider"></li>
                    <li><a href="<?php echo base_url('4236a440a662cc8253d7536e5aa17942') ?>"><i
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url('dashboard') ?>"><i class="fa fa-dashboard fa-fw"></i>
                            Dashboard</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('category2')?>"><i class="fa fa-table fa-fw"></i> CATEGORY</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('brand2')?>"><i class="fa fa-bar-chart-o fa-fw"></i> BRAND</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('product2')?>"><i class="fa fa-table fa-fw"></i> PRODUCT</a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="<?php echo base_url('category/manage') ?>">Manage Category</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo base_url('brand/add') ?>">Add Brand</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url('brand/manage') ?>">Manage Brand</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="<?php echo base_url('product/manage') ?>">Manage Product</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
